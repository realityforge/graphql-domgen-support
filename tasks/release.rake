...
### [v#{ENV['PRODUCT_VERSION']}](https://github.com/realityforge/graphql-domgen-support/tree/v#{ENV['PRODUCT_VERSION']}) (#{ENV['RELEASE_DATE']})
[Full Changelog](https://github.com/realityforge/graphql-domgen-support/compare/#{from}...v#{ENV['PRODUCT_VERSION']})
HEADER
